...
//TODOing: Finish this code to get the days repeat to work
-(NSDate *) getDateOfSpecificDay:(NSInteger ) day /// here day will be 1 or 2.. or 7
{
    NSDate *resultDate;
    for (NSString *dayString in self.daysChecked) {
            ...
            resultDate = [[NSCalendar currentCalendar] dateByAddingComponents:daysComponents toDate:[NSDate date] options:0];
//            return resultDate;
        }
